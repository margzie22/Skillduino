...
<section class="courses">
   <h1 class="heading">Beginner level projects</h1>

   <div class="box-container">
      <?php
      // Fetch all videos from the 'content' table, ordered by ID
      $videos_query = $conn->prepare("SELECT * FROM `content` WHERE playlist_id = 2 ORDER BY id ASC");
...
<section class="courses">
   ...
   <h1 class="heading">Assessments for Beginners</h1>

   <div class="box-container">

      <div class="box">
         <div class="thumb">
            <img src="images/BQ.jpg" alt="">
         </div>
         <h3 class="title">Beginner Quiz</h3>
         <a href="beginner_quiz.php" class="inline-btn">Take Quiz</a>
      </div>
   </div>
</section>
