...
<section class="courses">
   <h1 class="heading">Intermediate level projects</h1>

   <div class="box-container">
      <?php
      // Fetch all videos from the 'content' table, ordered by ID
      $videos_query = $conn->prepare("SELECT * FROM `content` WHERE playlist_id = 3 ORDER BY id ASC");
...
<section class="courses">
   ...
   <div class="box">
         ...
         <h3 class="title">Intermediate Quiz</h3>
         <a href="intermediate_quiz.php" class="inline-btn">Take Quiz</a>
      </div>
   </div>
</section>
